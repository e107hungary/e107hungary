...
$FEATUREBOX_TEMPLATE['bootstrap_carousel_default'] = '{SETIMAGE: w=1905&h=240&crop=1}
...
$FEATUREBOX_TEMPLATE['bootstrap_carousel_left'] = '<!-- slide -->
...
$FEATUREBOX_TEMPLATE['bootstrap_carousel_right'] = '{SETIMAGE: w=320&h=240&crop=1}
<div class="{FEATUREBOX_ACTIVE} item slide{FEATUREBOX_COUNTER}">
	<div class="container">
...
$FEATUREBOX_TEMPLATE['bootstrap_carousel_image'] = '{SETIMAGE: w=1905&h=240&crop=1}
<div class="{FEATUREBOX_ACTIVE} item slide{FEATUREBOX_COUNTER}">
	{FEATUREBOX_IMAGE=placeholder}
</div>
';
