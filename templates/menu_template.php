...
/**
 * @file
 * Override e107_core/templates/menu_template.php file.
 */
...
$MENU_TEMPLATE['2-column_1:1_text-left']['body'] = '<div class="cpage-menu col-lg-6 col-md-6 col-sm-6"><h2>{CMENUICON}{CMENUTITLE}</h2>{CMENUBODY}<p>{CPAGEBUTTON}</p></div>
